      ...
      <span className={css.elev}>Elevate your movie screening experience with our platform, having full control of your exhibition process! </span>
        ...
        <div className={css.sections}>
            ...
            <div className={css.d1}>
                ...
                <span  className={css.tmediadescription}>Easily manage all your digital cinema packages (DCPs) from a single dashboard. Managing your keys is now easier than ever. </span>
            </div>
            </div>
            ...
            <div className={css.d2}>
                ...
                <span  className={css.tmediadescription}>Get real-time insights into your box office performance, including ticket sales, and screen performance. Use this information to make data-driven decisions and optimize your marketing strategies. </span>
            </div>
            </div>
            ...
            <div className={css.d3}>
                ...
                <span  className={css.tmediadescription}>Keep track of all your agreements and contracts with stakeholders in one place. Get alerts when agreements are about to expire and automate the renewal process. </span>
            </div>
            </div>
            ...
            <div className={css.d4}>
                ...
                <span  className={css.tmediadescription}>Choose which ads to display on which screens and schedule them in advance. Make sure your advertisers reach their target audience and maximize your ad revenue. </span>
            </div>
            </div>

            <div className={css.sectionbox5}>
            <div className={css.d5}>
                <span className={css.tmediaheadings} >Screen and show configuration</span>
                <span  className={css.tmediadescription}>Configure your theatre screens and shows in a user-friendly interface. Manage show times, ticket prices, seating arrangements, and more. </span>
            </div>
            </div>
            ...
            <div className={css.d6}>
                ...
                <span  className={css.tmediadescription}>Streamline your payment process and get paid faster with our secure and easy-to-use payment gateway. Settle all payments on a weekly basis and automatically split movie revenue with other stakeholders. </span>
            </div>
            </div>
