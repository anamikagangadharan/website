...
const About = () => {
  return (
    <div className={css.container}>
        ...
        <div className={css.first}> <span>Discover everything you need to know about our company</span></div>
        <div className={css.second}>"Invicious"</div>
        <div className={css.third}>
        Our vision and mission to the amazing team behind our success. 
...
Let's dive in!
        ...
        <div className={css.scroll}> scroll</div>
         ...
         <div className={css.aboutmainthree}>
            ...
            <div className={css.boxmain}>
                ...
                <h1>Sinchana L</h1>
                    ...
                    <span>With an eye for detail and a focus, Sinchana ensures that the company operates smoothly and efficiently. 
                        Her various skill sets in finance and administration enable her to manage the financial aspects of the 
                        business, ensuring the growth of Invicious</span>
                </div>
            </div>
            <br />
         ...
         <div className={css.workculture}>
            ...
            <span>At Invicious, we foster a dynamic and agile work culture that promotes collaboration, creativity and innovation.
                 We believe that our success is built on the strength of our workforce. We strive to create an environment where
                  everyone can thrive and grow. 
We encourage our teammates to share their insights and perspectives freely, and promote a work environment that best suits their 
preferences. We prioritise personal and professional growth and development, providing opportunities to take ownership of their
 career paths and to pursue their passions within our organisation.
</span>
         </div>
